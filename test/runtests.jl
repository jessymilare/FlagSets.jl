...
@testset "Validate type" begin
    ...
    @test !isvalid(reinterpret(Flag1, UInt32(1<<3)))
    @test !isvalid(reinterpret(Flag1, UInt32(1<<4)))
    @test !isvalid(reinterpret(Flag1, UInt32(1<<5 | 1)))
    @test !isvalid(reinterpret(Flag1, UInt32(1<<29 | 1<<3)))
    ...
    @test !isvalid(reinterpret(Flag6, UInt8(1<<3)))
    @test !isvalid(reinterpret(Flag6, UInt8(1<<4)))
    @test !isvalid(reinterpret(Flag6, UInt8(1<<5 | 1)))
    @test !isvalid(reinterpret(Flag6, UInt8(1<<7 | 1<<3)))
